// src/constants/extendedCharacters.js

// A large, categorized list of AI characters for various use cases.
// Set `isDefault: false` so they can be managed by the user.
